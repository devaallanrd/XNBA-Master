...
namespace WEBUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Title = "LiveGame";
            return View();
          
        }
        public ActionResult LiveGame()
        {

            ViewBag.Title = "LiveGame | Narraciones";
            return View();

        }

        public ActionResult Narraciones()
        {
        ...
        public JsonResult GetArduino()
        {
           ...
           // Card = new ArduinoModel().readData();
            ...
            Usuario user = new RepoUsuario().EncontrarUsuario("");
